...
export default class ParkingSpotsController {
  ...
  public async getLastSpot({ params }: HttpContextContract) {
    let parkingSpot: ParkingSpot = await ParkingSpot.query()
      .where('parking_id', '=', params.parking_id)
      .orderBy('id', 'desc')
      .first()
    return parkingSpot
  }
  ...
  public async getByParkingId({ params }: HttpContextContract) {
    let parkingSpots: ParkingSpot[] = await ParkingSpot.query().where(
      'parking_id',
      '=',
      params.parking_id
    )
  ...
  public async update({ params, request }: HttpContextContract) {
    ...
    parkingSpot.occupied = body.occupied
